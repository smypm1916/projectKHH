...
public class ShopDTO {
    ...
    public ShopDTO(int shop_no, String shop_owner, String shop_name, String shop_addr, String shop_tel, String shop_content, String shop_opentime, String shop_addrtype) {
        super();
