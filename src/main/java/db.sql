...
-- INSERT INTO SHOP_IMAGE values (1, 'mise1.jpg','main');
-- INSERT INTO SHOP_IMAGE values (2, 'mise2.jpg','main');
-- INSERT INTO SHOP_IMAGE values (3, 'mise3.jpg','main');
-- INSERT INTO SHOP_IMAGE values (4, 'mise4.jpg','main');
-- INSERT INTO SHOP_IMAGE values (5, 'mise5.jpg','main');
-- INSERT INTO SHOP_IMAGE values (6, 'mise6.jpg','main');
--
-- insert into SCRAP_SHOP values ('1','user2@example.com','1','2025-01-03');
-- insert into SCRAP_SHOP values ('2','user2@example.com','2','2025-02-03');
-- insert into SCRAP_SHOP values ('1','user2@example.com','3','2025-01-03');
-- insert into SCRAP_SHOP values ('4','user2@example.com','4','2025-02-13');
-- insert into SCRAP_SHOP values ('5','user2@example.com','5','2025-02-05');
-- insert into SCRAP_SHOP values ('6','user2@example.com','6','2025-01-23');
--
--
-- insert into RESERVATION_INFO values ('1','1','user2@example.com','조수진','010-3385-6138','2025-01-03','2');
-- insert into RESERVATION_INFO values ('2','2','user2@example.com','조수진','010-3385-6138','2025-01-24','4');
-- insert into RESERVATION_INFO values ('3','3','user2@example.com','조수진','010-3385-6138','2025-03-13','3');
-- insert into RESERVATION_INFO values ('4','4','user2@example.com','조수진','010-3385-6138','2025-02-08','2');
-- insert into RESERVATION_INFO values ('5','5','user2@example.com','조수진','010-3385-6138','2025-02-25','3');
--
-- insert into RESERVATION_INFO values ('6','6','user2@example.com','조수진','010-3385-6138','2025-04-23','4');
--
--
-- insert into scrap_shop values ('1','user2@example.com','1','2025-01-03');
--
...
-- select * from RESERVATION_INFO;
-- select * from SCRAP_SHOP;
-- insert into SHOP_INFO values ('1','yamada','오니기리 아린코 오로라타운점 (おにぎりのありんこ オーロラタウン店)','〒060-0042 北海道札幌市中央区大通西2丁目 さっぽろ地下街オーロラタウン','011-222-0039
-- ','다양한 종류의 오니기리를 제공하는 전문점으로, 특히 치즈 가쓰오 오니기리가 인기입니다. ','8:00~20:00','도오');
--
-- insert into SHOP_IMAGE values ('5','mise5.jpg','main'
--                               );
...
--
-- insert into USER_ACCOUNT values ('user2@example.com','user2','조수진','1997-11-20','서울특별시 종로구','010-3385-6128','f','조조조','gold','profile1.jpg');
